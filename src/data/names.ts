...
export const names = [
  ...
  // 英語圏の名前（100種類）
  "Oliver", "Emma", "Noah", "Olivia", "Liam", "Ava", "Elijah", "Sophia", "James", "Isabella",
  "William", "Mia", "Benjamin", "Charlotte", "Lucas", "Amelia", "Henry", "Harper", "Alexander", "Evelyn",
  "Mason", "Abigail", "Michael", "Emily", "Ethan", "Elizabeth", "Daniel", "Sofia", "Jacob", "Avery",
  "Logan", "Ella", "Jackson", "Scarlett", "Levi", "Grace", "Sebastian", "Chloe", "Mateo", "Victoria",
  "Jack", "Riley", "Owen", "Aria", "Theodore", "Lily", "Aiden", "Aubrey", "Samuel", "Zoey",
  "Joseph", "Nora", "John", "Hannah", "David", "Brooklyn", "Wyatt", "Zoe", "Matthew", "Penelope",
  "Luke", "Layla", "Asher", "Leah", "Carter", "Addison", "Julian", "Natalie", "Grayson", "Lillian",
  "Leo", "Stella", "Jayden", "Ellie", "Gabriel", "Hazel", "Isaac", "Violet", "Lincoln", "Aurora",
  "Anthony", "Savannah", "Hudson", "Audrey", "Dylan", "Brooklyn", "Ezra", "Bella", "Thomas", "Claire",
  "Charles", "Skylar", "Christopher", "Lucy", "Jaxon", "Paisley", "Maverick", "Everly", "Josiah", "Anna",
  
  // フランス語圏の名前（50種類）
  "Louis", "Emma", "Gabriel", "Jade", "Raphaël", "Louise", "Arthur", "Alice", "Jules", "Chloé",
  "Adam", "Inès", "Lucas", "Léa", "Hugo", "Manon", "Maël", "Sarah", "Nathan", "Jeanne",
  "Tom", "Adèle", "Théo", "Juliette", "Liam", "Camille", "Noah", "Mathilde", "Léo", "Zoé",
  ...
  "Juwon", "Seoyun", "Sihu", "Haeun", "Suho", "Yuna", "Jiho", "Chaewon", "Yoon", "Sohee",
